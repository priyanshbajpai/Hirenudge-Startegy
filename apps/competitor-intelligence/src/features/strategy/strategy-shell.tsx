...
export function StrategyShell({ children }: { children: ReactNode }) {
  ...
  if (pathname === "/strategy/presentation") return <div className={styles.strategyRoot}>{children}</div>;
  ...
  return <div className={styles.strategyRoot}>
    ...
    <header className={styles.mobileHeader}>
      ...
      <Link href="/strategy" className={styles.mobileBrand}>HireNudge <span>Strategy</span></Link>
    ...
    <aside className={`${styles.strategyNav} ${menuOpen ? styles.strategyNavOpen : ""}`}>
      <div className={styles.navBrand}>
        <Link href="/strategy"><span className={styles.brandMark}>H</span><span><strong>HireNudge</strong><small>Founder Strategy</small></span></Link>
      ...
      <div className={styles.navLabel}>DECISION SYSTEM</div>
      ...
      <div className={styles.navFooter}>
        <Link href="/strategy/presentation" className={styles.presentationLink}><Presentation aria-hidden="true" size={17} /><span><strong>Presentation mode</strong><small>15-chapter founder narrative</small></span></Link>
        ...
        <p>No founder approvals recorded</p>
      </div>
    </aside>
    <main id="strategy-content" className={styles.strategyMain} tabIndex={-1}>
      <div className={styles.utilityBar}>
        <span>Research cut-off · 6 Aug 2026</span>
        <span className={styles.utilityStatus}><i aria-hidden="true" /> Internal evidence not supplied</span>
